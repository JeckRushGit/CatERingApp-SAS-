...
--
-- Struttura della tabella `kitchenavailabilities`
--
...
INSERT INTO `kitchenavailabilities` (`user_id`, `kitchenshift_id`) VALUES
(4, 1),
(4, 2),
(4, 3),
(5, 2);
...
INSERT INTO `kitchenshifts` (`id`, `start`, `end`, `full`) VALUES
(1, '23/02/2024 - 9:00', '23/02/2024 - 14:00', 0),
(2, '23/12/2023 - 16:00', '23/12/2023 - 22:00', 0),
(3, '23/03/2024 - 9:00', '23/03/2024 - 19:00', 0);
...
--
-- Indici per le tabelle `kitchenavailabilities`
--
ALTER TABLE `kitchenavailabilities`
  ADD PRIMARY KEY (`user_id`,`kitchenshift_id`);
