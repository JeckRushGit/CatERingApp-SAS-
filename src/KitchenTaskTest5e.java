...
public class KitchenTaskTest5e {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("CHANGE TASK TIME ESTIMATE");
            KitchenTask targetTask = sheet.getTasks().get(0);
            CatERing.getInstance().getKitchenTaskManager().changeTimeEstimate(targetTask, "25 minuti");
